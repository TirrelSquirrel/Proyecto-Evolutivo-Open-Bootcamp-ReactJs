...
const Ejemplo2 = () => {
  ...
  /**
   * ? Caso 1: Ejhecutar SIEMPRE un snippet de código
   ...
   * Cada vez que haya un cambio en contador 1, se ejectua lo que
   * diga el useEffect()
   * En caso de3 que cambie contador2, no habrá ejecución
   *
   */
   ...
   * Cada vez que haya un cambio en contador 1 o 2, se ejectua lo que
   * diga el useEffect()
   * En caso de que se cambie otro elemento, no pasará nada
   *
   */
